const PropertyCard = ({ imgUrl, name, price }) => {
  return (
    <div className="flex-1 rounded-3xs bg-gray-white box-border h-[466.99px] flex flex-col items-start justify-start py-[15px] px-[13px] gap-[23px] min-w-[355px] max-w-[400px] text-left text-[14.51px] text-gray-700 font-body-large-400 border-[1px] border-solid border-whitesmoke-100 hover:bg-gainsboro hover:cursor-pointer sm:w-[100%!important] sm:mb-5">
      ...
      <div className="flex flex-row items-start justify-start py-0 px-2.5 gap-[17px] text-[10.84px] text-gray-500">
